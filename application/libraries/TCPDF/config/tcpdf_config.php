 ...
 */
define ('PDF_HEADER_LOGO', 'PLN.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Laporan Dana Penugasan');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by PT PLN (Persero) PURSHARLIS | Visit : www.plnpusharlis.com");
