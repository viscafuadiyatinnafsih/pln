                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td><center><a class="btn btn-default" href="<?php echo site_url("pengadaan/rincian/get_pengadaan/$row->id_datapenugasan")?>" title="rincian pengadaan">Pengadaan</a></td>
                            <td><center><a class="btn btn-default" href="<?php echo site_url("pengadaan/danapersekot/get_persekot/$row->id_datapenugasan")?>" title="rincian persekot">Pembelian Langsung</a></td>
                            </tr>
                                <?php $i++?>
                                <?php endforeach?>
                        </tbody>
