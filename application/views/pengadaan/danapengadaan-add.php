                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="<?= site_url()?>/pengadaan/danapengadaan/add">
                                        
                                        <input type="hidden" name="id_danapengadaan" value="<?php if (@$detail){ echo @$detail->id_danapengadaan;} else { echo set_value('id_danapengadaan');}?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nilai_kontrak"  required class="form-control" placeholder="nilai_kontrak" value="<?php if (@$detail){ echo @$detail->nilai_kontrak;} else { echo set_value('nilai_kontrak');}?>" />
                                        </div>
