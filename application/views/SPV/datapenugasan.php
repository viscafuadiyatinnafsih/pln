                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><center><?php echo $row->deadline?></td>
                                             ...
                                             <!-- /. CARI DATA
                                            <td><center><a class="btn btn-warning" href="<?php echo site_url("SPV/danapengadaan/get_pengadaan/$row->id_datapenugasan")?>" title="rincian pengadaan">Pengadaan</a></td> -->

                                             
                                           <td><center><a class="btn btn-info" href="<?php echo site_url("SPV/danapersekot/get_persekot/$row->id_datapenugasan")?>" title="rincian persekot">Persekot</a></td> 
