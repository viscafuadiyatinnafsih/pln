                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td align="center"><a class="btn btn-default" href="<?php echo site_url("manager/danapengadaan/get_pengadaan/$row->id_datapenugasan")?>" title="rincian pengadaan">Pengadaan</a>
                            <a class="btn btn-default" href="<?php echo site_url("manager/danapersekot/get_persekot/$row->id_datapenugasan")?>" title="rincian persekot">Persekot</a></td>
                            </tr>
                                <?php $i++?>
                                <?php endforeach?>
                        </tbody>
